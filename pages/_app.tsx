...
function MyApp({ Component, pageProps }) {
  ...
  useEffect(() => {
    ...
    function createScene() {
      ...
      scene.fog = new THREE.Fog(colors.white, 300, 950);
  ...
  return (
    <ThemeProvider attribute="class">
      ...
      <div className="grid grid-cols-12 gap-6 px-5 my-14 lg:mb-0 md:mb-16 sm:px-20 md:px-32 lg:px-36 xl:px-48 ">
        ...
        <div className="hover:scale-125 h-full col-span-12 p-4 text-base text-center bg-white dark:bg-dark-500 lg:col-span-3 rounded-md shadow-custom-light dark:shadow-custom-dark">
          {/* //!sidebar */}
          <Sidebar />
        </div>
