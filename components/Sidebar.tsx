...
const Sidebar = () => {
  ...
  return (
    <>
      <Image
        src="/images/conner-headshot.png"
        alt="avatar"
      ...
      <h3 className="my-4 text-3xl font-medium tracking-wider font-hpr font-semibold">
        <span className="text-blue">Conner</span> Soligny
      </h3>
      ...
      <div className="flex justify-around w-9/12 mx-auto my-5 text-blue md:w-full">
        ...
        <motion.a
          whileHover={{ scale: 1.3 }}
          whileTap={{ scale: 0.9 }}
          href="https://www.linkedin.com/in/connersoligny/"
        >
        ...
        <motion.a
          whileHover={{ scale: 1.3 }}
          whileTap={{ scale: 0.9 }}
          href="https://github.com/csharpener22"
        >
      ...
      <div className="flex justify-around w-9/12 mx-auto my-5 text-blue md:w-full">
        <motion.a
          whileHover={{ scale: 1.3 }}
          whileTap={{ scale: 0.9 }}
          onClick={() => window.open("mailto:conner.soligny@gmail.com")}
        >
          <SiMinutemailer className="w-8 h-8 m-auto cursor-pointer" />{" "}
          <span className="text-sm font-hpr">Gmail</span>
        </motion.a>
        <motion.a
          whileHover={{ scale: 1.3 }}
          whileTap={{ scale: 0.9 }}
